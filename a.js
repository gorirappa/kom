...
String firstLtr = suru.substring(0, 1);
String restLtrs = suru.substring(1, suru.length());
firstLtr = firstLtr.toUpperCase();
surua = firstLtr + restLtrs;
document.write("<p>C 次の問い(<b>問１～３</b>)において、それぞれ下の語句を並び替えて空所を補い、文を完成させよ。解答は(２１)～(２２)に入れるものの番号のみを答えよ。</p><p>"+surua+" is "+keiyou+".</p>");
